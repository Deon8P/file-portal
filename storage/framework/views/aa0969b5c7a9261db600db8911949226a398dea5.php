...
-->
  ...
  <div class="text-center">
   ...
   <label class="h1 mb-5 transition-fade transition" style="color: #cc6600; font-size: 150px;">Wordable</label>

   <form class="form-sr" method="POST" action="/login">
    <?php echo e(csrf_field()); ?>

    <!-- CHANGE THIS TO THE LOGO OF WORDABLE!!! <img class="mb-4" src="../../assets/brand/bootstrap-solid.svg" alt="" width="72" height="72">-->
