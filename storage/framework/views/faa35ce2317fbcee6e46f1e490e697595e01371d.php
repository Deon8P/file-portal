<div class="collapse" id="navbarHeader" style="background: #1e2129">
  <div class="container">
    <div class="row">
      <div class="col-sm-8 col-md-7 py-4">
        <h4 class="text" style="color: #cc6600">About</h4>
      ...
      <div class="col-sm-4 offset-md-1 py-4" >
        <h4 class="text" style="color: #cc6600">Contact</h4>
...
<div class="navbar navbar-dark shadow" style="background: #1e2129">
  <div class="container d-flex justify-content-between">

    <?php if(Auth::check()): ?>
    <a href="#" class="navbar-brand d-flex align-items-center" style="color: #cc6600">
