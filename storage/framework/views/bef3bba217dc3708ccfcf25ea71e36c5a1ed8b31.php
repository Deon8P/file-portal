  ...
  <div class="card mb-4 shadow-sm"style="background-color: lightgrey; border-radius: 4px; border-color: #cc6600;">   
    <div class="card-body transition" >
      <div class="">
        ...
        <label class="card-text float-right" style="color: #cc6600;">Shared</label><br>
        ...
        <form action="/files/<?php echo e($file->id); ?>/removeColaborators" method="POST" enctype="multipart/form-data">
          <?php echo e(csrf_field()); ?>


          <br>

          <a href style="color: #ff8c1a;" data-toggle="modal" data-target="#removeColaborators<?php echo e(md5($file->id)); ?>">Shared with ...</a>

          <!--Begining of modal dialog -->
          <div class="modal fade" id="removeColaborators<?php echo e(md5($file->id)); ?>" tabindex="-1" role="dialog" aria-labelledby="removeColaborators<?php echo e(md5($file->id)); ?>" aria-hidden="true">
            <div class="modal-dialog" role="dialog">
              <div class="modal-content" style="background: #1e2129">
                <div class="modal-header">
                  <h5 class="modal-title " id="removeColaborators<?php echo e(md5($file->id)); ?>" style="color: #cc6600;">Shared with ...</h5>
                ...
                <div class="modal-body">
                  ...
                  <div class="form-group">
                    ...
                    <?php if(count(explode(",",$file->colaborators)) > 1): ?>
                    <h1 class="col-form-label" style="color: #cc6600;">Colaborators</h1>

                    <ul>
                      <?php $__currentLoopData = explode(",",$file->colaborators); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colaborator): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                      <?php if(strlen($colaborator) > 2): ?>

                      <li style="color: white;"><?php echo e($colaborator); ?></li>
                    ...
                    <?php else: ?>
                    <h1 class="col-form-label" style="color: white;">This file has no colaborators.</h1>
                    <?php endif; ?>
        ...
        <div class="d-flex justify-content-between align-items-center">
          ...
          <form action="/files/<?php echo e($file->id); ?>/addColaborators" method="POST" enctype="multipart/form-data">
            ...
            <button class="btn btn-sm mt-3" style="color: #ff8c1a" data-toggle="modal" data-target="#addColaborators<?php echo e(md5($file->id)); ?>">Share</button>
