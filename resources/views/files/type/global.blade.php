    ...
    <div class="card mb-4 shadow-sm"style="background-color: lightgrey; border-radius: 4px; border-color: #cc6600;">
      <div class="card-body transition" >
        <div class="">
          ...
          <i class="material-icons float-right ml-1" style="text-shadow: 0px 0px 1px #cc6600; border-bottom: 3px solid lightgrey; cursor: pointer;" onclick="">public</i>
          <label class="card-text float-right" style="color: #cc6600;">Global</label>
