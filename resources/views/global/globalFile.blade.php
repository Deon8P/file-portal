    ...
    <div class="card mb-4 shadow-sm"style="background-color: lightgrey; border-radius: 4px; border-color: #cc6600;">
      <div class="card-body transition" >
        <div class="">
          ...
          <small class="card-text" >Owner: <a href="/dashboard" style="color: #ff8c1a; cursor: pointer;">{{ $file->owner_username }}</a></small>
          ...
          <small class="card-text" >By: <a href="/dashboard"style="color: #ff8c1a; cursor: pointer;">{{ $file->last_uploader_username }}</a></small>
